...
verdict: "Every number on the site, gathered in one place with its source — each checked against the paper and linked so you can read further."
---

# Provenance of the figures

A site that weighs other people's evidence has to show its own. **Every figure used anywhere on the site is listed below, with the study it comes from and a link to the paper** — checked against the source, so nothing floats free of a citation and you can always read further.

A note on the arithmetic: a few figures (the roulette house edge, slot return-to-player) are not study results at all but **published design parameters or definitions** — specifications rather than estimates, which is why they need no study to back them.

## Sources

### Smoking

- **Doll & Hill, [BMJ 1950;2:739](<https://doi.org/10.1136/bmj.2.4682.739>)** — hospital case-control, 649 lung cancer cases.
- **Doll et al., [BMJ 2004;328:1519](<https://doi.org/10.1136/bmj.38142.554479.AE>)** (British Doctors Study) — ~10 years of life lost; cessation at 60/50/40/30 gaining ~3/6/9/10 years; 34,439 doctors, 50 years' follow-up.
- **Pirie et al., [Lancet 2013;381:133](<https://doi.org/10.1016/S0140-6736(12)61720-6>)** (Million Women Study) — stopping before 40 avoids >90% of excess mortality; before 30, >97%.
- **Jha et al., [NEJM 2013;368:341](<https://doi.org/10.1056/NEJMsa1211128>)** — reproduces the ~10-year deficit in a US cohort.
- **Banks et al., [BMC Med 2015;13:38](<https://doi.org/10.1186/s12916-015-0281-z>)** — roughly two-thirds of lifelong smokers killed by smoking.
...
- **Zhao, Stockwell, Naimi et al., [JAMA Netw Open 2023;6:e236185](<https://doi.org/10.1001/jamanetworkopen.2023.6185>)** — 107 cohort studies, 4.8 million participants; no significant mortality reduction below 25 g/day; increased mortality at ≥25 g/day in women and ≥45 g/day in men; corrected May 2023.
- **Millwood et al., [Lancet 2019;393:1831](<https://doi.org/10.1016/S0140-6736(18)31772-0>)** (China Kadoorie Biobank) — ~500,000 participants; *ALDH2* / *ADH1B* instruments; monotonic linear stroke risk.
- **Collaborative Group on Hormonal Factors in Breast Cancer, [Br J Cancer 2002](<https://doi.org/10.1038/sj.bjc.6600596>)** — breast cancer risk ~7% per 10 g/day of alcohol.
- **IARC [Monograph 100E](<https://www.ncbi.nlm.nih.gov/books/NBK304380/>)** — alcoholic beverages classified Group 1 (carcinogenic to humans).
- **[UK Chief Medical Officers' low-risk drinking guidelines, 2016](<https://www.gov.uk/government/publications/alcohol-consumption-advice-on-low-risk-drinking>)** — no level completely safe; keep to ≤14 units/week.
- **[Canada's Guidance on Alcohol and Health, CCSA 2023](<https://www.ccsa.ca/canadas-guidance-alcohol-and-health>)** — a continuum of risk rather than a threshold.
...
- **PREDIMED (Estruch et al., [NEJM 2018](<https://doi.org/10.1056/NEJMoa1800389>))** — ~30% relative reduction in major cardiovascular events; retracted and republished after randomisation irregularities.

### Movement

- **WHO 2020 guidelines (Bull et al., [Br J Sports Med 2020;54:1451](<https://doi.org/10.1136/bjsports-2020-102955>))** — 150–300 min/week of moderate activity for adults.
